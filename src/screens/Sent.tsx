...
type SentNavigationProp = StackNavigationProp<RootStackParamList, 'Sent'>

type SentProps = {
    navigation: SentNavigationProp;
    route: RouteProp<RootStackParamList, 'Sent'>;
};

function Sent({ navigation, route }: SentProps): JSX.Element {
